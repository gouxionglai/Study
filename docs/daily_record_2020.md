...
找到工作了，虽然也有点坑，我比较着急，只面了两家就过了。

后面更新速度可能要更慢了 23333

# 2020-08-12

不知不觉都快过了两个月了。 现在的公司几乎都是老业务。基本是维护任务，基本都是C#程序。头大。 好在写得还可以，连猜带蒙勉强能看懂。 但是喊自己写完全下不了手。

日常更新：  还在学Spring Cloud。  

确实学得越多，越发现自己的渺小。   希望能赶紧形成自己的一套知识体系，而不是学完就忘了。